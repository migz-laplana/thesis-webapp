...
<body class="bgbody">
	...
	<div class="pagetitle"> Driver Cash Out </div> <hr> <br>
	...
	<div class="bodymain">
		<form action="db_update.php" method="post">
			...
			<div class="row">
				<div class="col-3 label">Amount to Withdraw: ₱ <text class="textlorange">*</text> </div>
				<div class="col-9">
					<input type="text" class="input" name="TransAmt" id="TransAmt" placeholder="Amount to Withdraw" required>
				</div>
			</div><br>
...
<script type="text/javascript">
	$(document).ready(function(){
		$('#transfer').empty();
		$('#transfer').append('<a class="active" href="page_drivercashout.php">Driver Cash Out</a>');
	});
</script>
